                    ...
                    <div class="d-flex justify-content-center align-items-center mt-4">
                        <form id="search" role="get" class="" action="/find" style="width:50%;">
                            <div class="input-group">
                                <input type="search" name="req" value="" placeholder="search for a post" class="form-control">
        ...
        <div class="card-body">
            <ul class="list-group list-unstyled text-center">
                @foreach($articles as $article)
                    <a href="/articles/{{$article->id}}" style="text-decoration:none;"><li class="list-group-item">{{$article->title}} <em class="" style="font-size:12px;">Created at: {{$article->created_at}}</em></li></a>
                @endforeach
            </ul>
        </div>
    </div>
